    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            foreach (ChiTietToppingRP cttp in listCTTP)
            {
                ...
                //    temp2.GiaTopping = (decimal)cttp.Topping.Gia;
                ...
                if (cttp.Topping != null && cttp.Topping.Gia != 0 && cttp.SoLuong != 0)
                {
                    ...
                    // Thêm thông tin chung vào đối tượng tạm thời
                    temp2.TenBan = hoaDonChung.TenBan;
                    temp2.TenNV = hoaDonChung.TenNV;
                    temp2.TenKH = hoaDonChung.TenKH;
                    temp2.Ngay = hoaDonChung.Ngay;

                    // Thêm thông tin topping vào đối tượng tạm thời
                    temp2.TenTopping = cttp.Topping.Ten;
                    temp2.GiaTopping = (decimal)cttp.Topping.Gia;
                    temp2.SoLuongTopping = (int)cttp.SoLuong;

                    // Thêm đối tượng tạm thời vào danh sách
                    tempListRp.Add(temp2);
                }
            }
